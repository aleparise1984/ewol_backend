...
const module_items_entity_1 = require("./entities/module_items.entity");
const module_entity_1 = require("./entities/module.entity");
let ModuleModule = class ModuleModule {
};
ModuleModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([module_entity_1.Module, module_items_entity_1.ModuleItem])],
